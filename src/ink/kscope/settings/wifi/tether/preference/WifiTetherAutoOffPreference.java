...
public class WifiTetherAutoOffPreference extends SeekBarDialogPreference implements
    ...
    public String getSummaryForTimeout(int timeout) {
        if (timeout == 0) {
            return mContext.getResources().getString(R.string.wifi_hotspot_auto_off_timeout_never);
        } else {
            return mContext.getResources().getQuantityString(R.plurals.wifi_hotspot_auto_off_timeout, timeout, timeout);
        }
    }
